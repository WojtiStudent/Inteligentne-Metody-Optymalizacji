...
class ILS:
    def __init__(self, solution_initializer, lifespan, algorithm=SteepestSearchWithMemory,
                no=1, destroy_ratio=0.2, n_moves=10, with_local_search=True, rebuild_algorithm=tcp_greedy_cycle_two_regret_heuristic):
    ...
    def __call__(self, distance_matrix):        
        ...
        if self.no == 1:
            while time() - start < self.lifespan:
                ...
                tmp_solution = self.algorithm(self.solution_initializer)(distance_matrix)
